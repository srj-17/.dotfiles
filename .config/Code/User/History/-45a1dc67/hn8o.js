...
function displayBooks() {
    ...
    myLibrary.forEach((book) => {
        ...
        bookInfo = book.info(); 
        bookCard.innerHTML = `<div class="title-container card-label">
                                <div class="card-label"> Title: </div>
                                <div class="title"> ${book.title} </div>
                              </div>
                              <div class="author-container card-label">
                                <div class="card-label"> Author: </div>
                                <div class="author"> ${book.author} </div>
                              </div>
                              <div class="pages-container card-label">
                                <div class="card-label"> Pages: </div>
                                <div class="pages"> ${book.pages} </div>
                              </div>
                              <div class="read-container card-label">
                                <div class="card-label"> Read: </div>
                                <div class="read"> ${book.read} </div>
                              </div>
                              <div class="author card-label">
                                Author: ${book.author}</div>
                            <div class="pages card-label">Pages: ${book.title}</div>
                            <div class="read card-label">Read: ${book.read ? 'read' : 'not read'} </div>`;
