...
// because then we'll have to clear each one of them and that means changing other modules to behave as 
...
contentLeft.classList.toggle('middle-line');
let contentRight = document.createElement('div');
contentLeft.classList.toggle('content-right');
