...
let gameController = (function () {
    ...
    function resetButtonHandler() {
        ...
        displayController.showPlayer(activePlayer.getName(), gameController.getTimeOutTime());    
    }
    ...
    function winnerHandler(e) {
        if (Array.from(e.target.classList).includes('play-again-button')) {
            gameboard.resetBoard();
            winnerDialog.close();
            displayController.showPlayer(gameController.activePlayer.getName(), gameController.getTimeOutTime());
    ...
    return {
        ...
        playGame, setPlayerNames, resetCheckWinnerCount, getTimeOutTime, resetButtonHandler,
