...
let gameController = (function() {
    ...
    return {playRound, checkWinner, changeActivePlayer, playGame, setPlayerNames, resetCheckWinnerCount, getActivePlayer};
}) ();
...
resetButton.addEventListener('click', () => {
    ...
    const TIMEOUT_PERIOD = 1000;
    displayController.showPlayer(gameController.getActivePlayer().getName(), TIMEOUT_PERIOD);
})
