...
// chatgpt: modules vs plugins
    // Modules (and their associated loaders) are mainly concerned with transforming and processing individual files (like transpiling JS or loading CSS).
    // Plugins are used to extend Webpack's capabilities and perform more complex, global tasks that affect the entire build process.