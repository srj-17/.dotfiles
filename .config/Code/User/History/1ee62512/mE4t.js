...
class Project {
    ...
    editTodo(title, description, duedate, priority, notes, checklist, id) {
        let valueList = [title, description, duedate, priority, notes, checklist];
        let index = id;
        let todo = this.todoList.at(index);
