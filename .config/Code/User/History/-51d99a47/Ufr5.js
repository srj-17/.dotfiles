...
const user = (function () {
    ...
    console.log(directTodos.addTodo())
...
user.addTodo("hello", "this is the todo of todods", "2011-10-1", 1, "ok these are notes for this project", ['hello', 'these', 'are', 'things', 'to', 'do'])
