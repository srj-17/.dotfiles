return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>gb", "<cmd>Gitsigns toggle_current_line_blame<Enter>",{silent = true, noremap = true })
        end
    },
    {
        ...
        config = function ()
            ...
            vim.keymap.set("n", "<leader>dv", "<cmd>Gvdiffsplit!<cr>", {silent = true, noremap = true, desc = "open diff view" })
            vim.keymap.set("n", "gh", "<cmd>diffget //2<cr>", {silent = true, noremap = true, desc = "select left diff" })
            vim.keymap.set("n", "gl", "<cmd>diffget //3<cr>", {silent = true, noremap = true, desc = "select right diff" })
        end
    },
    -- {
